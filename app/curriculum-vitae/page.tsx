...
export default function Page(){
  ...
  return(
    ...
    <div className="mx-5 lg:mx-14">
      ...
      {/* About me */}
      <div>
        <h2 className="text-lg font-semibold tracking-wider">ABOUT ME</h2>
        <div className="flex-auto text-md font-normal">
          <p className="mb-2">DOB: 01/02/1995</p>
      ...
      {/* Qualification */}
      <div className="mt-8">
        <h2 className="text-lg font-semibold tracking-wider">EDUCATION AND QUALIFICATION</h2>
